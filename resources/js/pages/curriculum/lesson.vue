<template>
    <div class="container">
        ...
        <div class="flex justify-between">
            <div>
                <button class=" text-teal-500 rounded-full font-bold py-4 px-6 mr-2 flex items-center hover:bg-teal-500 hover:text-white">
        ...
        <div class="flex justify-center mt-24">
            <div class="text-4xl bold font-serif mb-10 border-b-2 border-black w-1/4 pl-2 mr-5">Do</div>
